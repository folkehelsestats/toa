...
kjHC <- hchart(kjAlko, "column", hcaes(x = gender, y = pros, group = alko)) |>
  ## hc_colors(c("rgba(57,123,143,1)", "rgba(32,98,118,1)")) |>
  hc_colors(c("rgba(57,123,143,1)", "rgba(165,105,189,1)")) |>  # Teal and purple
