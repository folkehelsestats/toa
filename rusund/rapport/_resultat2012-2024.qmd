...
drkAlle <- proscat_weighted("year", "alkosistaar", d = DD, weight = "nyvekt2", total = FALSE)
drk <- proscat_weighted("year", "alkosistaar", z = "kjonn", d = DD, weight = "nyvekt2",total = FALSE)
...
drukkMen <- proscat_weighted("year", "alkosistaar", d = DD[kjonn == 1], weight = "nyvekt2", total = F, z = "agecat")
drukkWom <- proscat_weighted("year", "alkosistaar", d = DD[kjonn == 2], weight = "nyvekt2", total = F, z = "agecat")
```
...
DD[, drukket2rec := fcase(drukket1 == 2, 0,
                        drukket2 %in% 8:9, NA,
                        default = as.numeric(drukket2))]

drikkfreq <- proscat_weighted("year", "drukket2rec", d = DD, weight = "nyvekt2", total = F)
drikkfreqKjonn <- proscat_weighted("year", "drukket2rec", z="kjonn", d = DD, weight = "nyvekt2", total = F)
drikkfreqMen <- proscat_weighted("year", "drukket2rec", d = DD[kjonn == 1], weight = "nyvekt2", total = F)
drikkfreqWom <- proscat_weighted("year", "drukket2rec", d = DD[kjonn == 2], weight = "nyvekt2", total = F)
...
## DD[, drink66 := fcase(audit3 %in% 1:4, 1, #Daglig, ukenlig, månedlig og sjeldenere
##                      audit3 == 5, 0, #aldri
##                      drukket1 == 2, 0,
##                      default = 0)]

drk6 <- proscat_weighted(x = "year", y = "drink6", d = DD, weight = "nyvekt2", total = FALSE)
drk6kjonn <- proscat_weighted(x = "year", y = "drink6", z = "kjonn", d = DD, weight = "nyvekt2", total = FALSE)
...
drk6Men <- proscat_weighted("year", "drink6", d = DD[kjonn == 1], total = F, weight = "nyvekt2", z = "agecat")
drk6Wom <- proscat_weighted("year", "drink6", d = DD[kjonn == 2], total = F, weight = "nyvekt2", z = "agecat")
```
