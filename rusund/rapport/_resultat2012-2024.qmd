...
group_age(dt = ddt, var = "alder", breaks = ageBreak,
...
drkAlle <- proscat_weighted("year", "alkosistaar", d = ddt, weight = "nyvekt2", total = FALSE)
drk <- proscat_weighted("year", "alkosistaar", z = "kjonn", d = ddt, weight = "nyvekt2",total = FALSE)
...
Andelen som rapporterte å ha konsumert alkohol i løpet av de siste 12 månedene
  har vært relativt stabil i perioden 2012 til 2024, og har ligget mellom `r round(drkMin, digits = 1)`%
...
drukkMen <- proscat_weighted("year", "alkosistaar", d = ddt[kjonn == 1], weight = "nyvekt2", total = F, z = "agecat")
drukkWom <- proscat_weighted("year", "alkosistaar", d = ddt[kjonn == 2], weight = "nyvekt2", total = F, z = "agecat")
```
...
drikkfreq <- proscat_weighted("year", "drukket2rec", d = ddt, weight = "nyvekt2", total = F)
drikkfreqKjonn <- proscat_weighted("year", "drukket2rec", z="kjonn", d = ddt, weight = "nyvekt2", total = F)
drikkfreqMen <- proscat_weighted("year", "drukket2rec", d = ddt[kjonn == 1], weight = "nyvekt2", total = F)
drikkfreqWom <- proscat_weighted("year", "drukket2rec", d = ddt[kjonn == 2], weight = "nyvekt2", total = F)
...
I perioden 2012–2024 har det vært små kjønnsforskjeller blant personer som
...
make_hist(d = drikkFDT[drukket2rec == 1],
          ...
          group = kjonn2,
          n = count,
          title = "Alkoholbruk daglig siste 12 måneder 2012-2024",
          subtitle = "Kilde: Rusundersøkelse 2012-2014 ",
          type = "line",
          yint = 5,
          dot_size = 4,
...
make_hist(d = drikkFDT[drukket2rec == 2],
          ...
          group = kjonn2,
          n = count,
          title = "Alkoholbruk ukenlig siste 12 måneder 2012-2024",
          subtitle = "Kilde: Rusundersøkelse 2012-2014 ",
          type = "line",
          yint = 5,
          dot_size = 4,
...
make_hist(d = drikkFDT[drukket2rec == 3],
          ...
          group = kjonn2,
          n = count,
          title = "Alkoholbruk månedlig siste 12 måneder 2012-2024",
          subtitle = "Kilde: Rusundersøkelse 2012-2014 ",
          type = "line",
          yint = 5,
          dot_size = 4,
...
make_hist(d = drikkFDT[drukket2rec == 4],
          ...
          group = kjonn2,
          n = count,
          title = "Alkoholbruk sjeldnere enn månedlig siste 12 måneder 2012-2024",
          subtitle = "Kilde: Rusundersøkelse 2012-2014 ",
          type = "line",
          yint = 5,
          dot_size = 4,
...
drk6 <- proscat_weighted(x = "year", y = "drink6", d = ddt, weight = "nyvekt2", total = FALSE)
drk6kjonn <- proscat_weighted(x = "year", y = "drink6", z = "kjonn", d = ddt, weight = "nyvekt2", total = FALSE)
...
drk6Men <- proscat_weighted("year", "drink6", d = ddt[kjonn == 1], total = F, weight = "nyvekt2", z = "agecat")
drk6Wom <- proscat_weighted("year", "drink6", d = ddt[kjonn == 2], total = F, weight = "nyvekt2", z = "agecat")
```
...
perioden 2012 til 2024. Tallene er justert for forskjeller i kjønn og alder i
...
source("analysis2012_2024/drikke-enhet-1224.R")
...
alkoholenheter enn kvinner siste fire uker i perioden fra 2012 til 2024.

```{r fig-alko-enhet-menn}
#| echo: false
#| warning: false

enhetMenn <- enhetKjonn[kjonn == 1]
list_data_menn <- mapply(function(low, high) list(low = low, high = high),
                         enhetMenn$lower_enhet, enhetMenn$upper_enhet,
                         SIMPLIFY = FALSE)

highchart() |>
  hc_chart(type = "line") |>
  hc_title(text = "Alkoholbruk siste 4 uker blant menn") |>
  hc_xAxis(categories = enhetMenn$year) |>
  hc_yAxis(
    title = list(text = "Antall alkoholeneheter"),
    min = 0,
    max = 35) |>
  hc_add_series(name = "Antall enheter ", data = enhetMenn$adj_enhet, type = "line") |>
  hc_add_series(
    name = "95% CI",
    data = list_data_menn,
    type = "arearange",
...
```{r fig-alko-enhet-kvinner}
#| echo: false
#| warning: false

enhetKvinner <- enhetKjonn[kjonn == 2]
list_data_kvinner <- mapply(function(low, high) list(low = low, high = high),
                         enhetKvinner$lower_enhet, enhetKvinner$upper_enhet,
                         SIMPLIFY = FALSE)

highchart() |>
  hc_chart(type = "line") |>
  hc_title(text = "Alkoholbruk siste 4 uker blant kvinner") |>
  hc_xAxis(categories = enhetKvinner$year) |>
  hc_yAxis(
    title = list(text = "Antall alkoholeneheter"),
    min = 0,
    max = 35) |>
  hc_add_series(name = "Antall enheter ", data = enhetKvinner$adj_enhet, type = "line") |>
  hc_add_series(
    name = "95% CI",
    data = list_data_kvinner,
    type = "arearange",
    linkedTo = ":previous",
    color = hex_to_rgba("#206276", 0.3),
    fillOpacity = 0.3
...
<!-- {{< include _alkoenheter2012-2024.R >}} -->
