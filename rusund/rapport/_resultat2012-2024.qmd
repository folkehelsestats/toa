...
create_ci_graph(data = enhetTbl, title = "Alkoholbruk siste 4 uker")
```
...
create_ci_graph(data = enhetMenn, title = "Alkoholbruk siste 4 uker blant menn")
```
...
create_ci_graph(data = enhetKvinner, title = "Alkoholbruk siste 4 uker blant kvinner")
