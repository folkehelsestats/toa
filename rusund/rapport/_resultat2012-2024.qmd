...
drikkfreq <- proscat("year", "drukket2rec", d = DD, total = F)
drikkfreqKjonn <- proscat("year", "drukket2rec", z="kjonn", d = DD, total = F)
drikkfreqMen <- proscat("year", "drukket2rec", d = DD[kjonn == 1], total = F)
drikkfreqWom <- proscat("year", "drukket2rec", d = DD[kjonn == 2], total = F)
...
drk6 <- proscat(x = "year", y = "drink6", d = DD, total = FALSE)
drk6kjonn <- proscat(x = "year", y = "drink6", z = "kjonn", d = DD, total = FALSE)
