...
En alkoholenhet tilsvarer 15ml ren alkohol. Dette tilsvarer omtrent `r round(1.5/0.12, digits = 1)` cl for vin,
`r round(1.5/0.045, digits = 1)` cl for øl og `r round(1.5/0.40, digits = 0)` cl for brennevin,
