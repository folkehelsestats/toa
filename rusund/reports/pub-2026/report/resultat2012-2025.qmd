...
## druk1b finnes ikke i 2012 og 2013 datasettet
make_hist(d = alkoHist[status == 1 & year > 2013],
          x = year,
          y = percentage,
          n = count,
          group = type,
...
## druk1b finnes ikke i 2012 og 2013 datasettet
make_hist(d = alkoHistKjonn[status == 1 & kjonn == 1 & year > 2013],
          x = year,
          y = percentage,
          n = count,
          group = type,
...
## druk1b finnes ikke i 2012 og 2013 datasettet
make_hist(d = alkoHistKjonn[status == 1 & kjonn == 2 & year > 2013],
          x = year,
          y = percentage,
          n = count,
          group = type,
