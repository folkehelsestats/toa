...
source("../scripts/vintage/setup2025.R")
...
source("../scripts/vintage/drukket-year.R")
```
...
```{r cal2-druk-fig}
#| fig-cap: "Figure 17: Alkohol siste 12 måneder"
...
make_hist(d = alko,
          ...
          group = alkoyr,
          n = count,
          title = "Figure 17: Alkohol siste 12 måneder")
```
...
source("../scripts/vintage/drikk-frekvens.R")
```
...
#| fig-cap: "Figur 18: Drikkerfrekvens siste 12 måneder"
...
make_hist(d = alkofreq,
          ...
          group = alkof,
          n = count,
          title = "Figur 18: Drikkerfrekvens siste 12 måneder")
...
## Figur
```{r cal2-druk6-fig}
#| fig-cap: "Figur 19: Andel som har drukket 6 eller flere alkoholenheter ved en og samme anledning, 2025"
...
make_hist(d = drk6_25,
          ...
          group = alko,
          n = n,
          title = "Figur 19: Andel som har drukket 6 eller flere alkoholenheter ved en og samme anledning, 2025")
```
...
source("../scripts/vintage/drikk-enheter.R")
```
...
Gjennomsnittlig ølkonsum i en fire uke periode i 2025 var `r kjonncl[kjonn == 1, V1]`
enheter (0.33cl) blant menn og `r kjonncl[kjonn == 2, V1]` enheter blant kvinner.

```{r cal2-beer-fig}
#| echo: false
#| warning: false
#| fig-cap: "Figur 20: Antall øl enheter drukket siste 4 uker (33cl)"

simple_hist(beer$both,
            x = agecat,
            y = enhet,
            group = gender,
            title = "Figur 20: Antall øl enheter drukket siste 4 uker (33cl)")
...
`r wine$gender[kjonn == 1, V1]` for menn og `r wine$gender[kjonn == 2, V1]` for kvinner.


```{r cal2-vin-fig}
#| echo: false
#| warning: false
#| fig-cap: "Figur 21: Antall vin enheter drukket siste 4 uker (12.5cl)"

simple_hist(wine$both,
            x = agecat,
            y = vinglass,
            group = gender,
            title = "Figur 21: Antall vin enheter drukket siste 4 uker (12.5cl)")
```
...
Menn hadde i gjennomsnitt `r brenn$gender[kjonn == 1, V1]` glass brennevin sammenlikne med kvinner som hadde
`r brenn$gender[kjonn == 2, V1]` glass i siste 4 uker.

```{r cal2-brennevin-fig}
#| echo: false
#| warning: false
#| fig-cap: "Figur 22: Antall brennevin enheter drukket siste 4 uker (4cl)"

simple_hist(brenn$both,
            x = agecat,
            y = glass,
            group = gender,
            title = "Figur 22: Antall brennevin enheter drukket siste 4 uker (4cl)")
...
`r rusbrus$gender[kjonn == 1, V1]` og for kvinner `r rusbrus$gender[kjonn == 2, V1]`.

```{r cal2-rusbrus-fig}
#| echo: false
#| warning: false
#| fig-cap: "Figur 23: Antall rusbrus enheter drukket siste 4 uker (33cl)"

simple_hist(rusbrus$both,
            x = agecat,
            y = flaske,
            group = gender,
            title = "Figur 23: Antall rusbrus enheter drukket siste 4 uker (33cl)")
...
Gjennomsnittlig konsum av ren alkohol var `r genderAlk[kjonn == 1, V1]` cl blant menn og
`r genderAlk[kjonn == 2, V1]` cl blant kvinner.

```{r cal2-renalko-fig}
#| echo: false
#| warning: false
#| fig-cap: "Figur 24: Total mengde alkohol konsumet siste 4 uker (cl)"
...
simple_hist(tblAlk,
            ...
            group = gender,
            title = "Figur 24: Total mengde alkohol konsumet siste 4 uker (cl)")
```
...
#| echo: false
#| warning: false
#| fig-cap: "Figur 25: Andel alkoholkonsum i centiliter ren alkohol siste 4 uker fordelt på drikkesort"
...
make_hist(drikkTbl,
      ...
      y = pros,
          ...
          n = value,
          yint = 10,
          title = "Figur 25: Andel alkoholkonsum i centiliter ren alkohol siste 4 uker fordelt på drikkesort")
```
...
#| echo: false
#| warning: false
#| fig-cap: "Figur 26: Drikkemønster: Ukedager og helgedager"
...
make_hist(ukeDT,
          ...
          n = count,
          title = "Figur 26: Drikkemønster: Ukedager og helgedager")
