...
source(file.path(curdir, "analysis2025/setup2025.R"))
...
source(file.path(curdir, "analysis2025/drukket-year.R"))
```
...
source(file.path(curdir, "analysis2025/drikk-frekvens.R"))
```
...
source(file.path(curdir,"analysis2025/drikk-enheter.R"))
```
