...
Det var `r sum(kfa_oppdatert$q2_2 == "Ja", na.rm = TRUE)` kommuner som oppga at de hadde gitt skjenkebevillinger på andre steder enn barer, diskotek, klubber, kaffer og resturanter. 
...
[Bør vi vurdere å presentere antall kommuner som har gitt skjenkebevillinger til andre enn barer etc for å si noe om hvor "vanlig" det er?]{.mark}
...
Det var `r sum(kfa_oppdatert$q2_5 == "Ja", na.rm = TRUE)` kommuner som rapporterte å ha vilkår knyttet til noen av skjenkebevillingene i 2024. 
...
Det var `r sum(kfa_oppdatert$q1_6 == "Ja", na.rm = TRUE)` kommuner som rapporterte overtredelser knyttet til salgsbevillinger i 2024. Totalt ble det avdekket `r sum(kfa_oppdatert$otg_salg24, na.rm = TRUE)` overtredelser knyttet til salgsbevillinger. Fordelingen av de ulike overtredlsene vises under.
...
I spørsmål om kommunen har utarbeidet alkoholpolitsk handlingplan (eller liknende føringer for alkoholpolitikken, for eksempel retningslinjer), sier X % av kommunene at de gjør dette. 
...
X % av kommunene rapporterer at de har mottatt veildning. Videre rapporterer disse å få veiledning fra ulike aktører.
...
# Antall kommuner som har rapportert overtredelser knyttet til skjenkesbevillinger:
